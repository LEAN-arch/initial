...
with st.sidebar:
    ...
    display_categories = list(category_mapping[st.session_state.language REPLACE_WITH_DOT keys())
...
if not st.session_state.show_intro:
 ...
 columns=["Puntuación" if st.session_state.language == "Español" else "Score"])
