        ...
        if st.session_state.show_results:
            ...
            with st.spinner(TRANSLATIONS[st.session_state.language]["generating_excel"]):
                try:
                    ...
                    href_excel = (
                        f'<a href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64_excel}" download="{TRANSLATIONS[st.session_state.language]["report_filename_excel"]}" class="btn btn-primary">{TRANSLATIONS[st.session_state.language]["download_excel"]}</a>'
                    )
